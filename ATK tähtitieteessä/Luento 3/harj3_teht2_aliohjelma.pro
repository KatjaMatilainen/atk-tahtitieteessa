...
pro harj3_teht2_aliohjelma, x, n, yllattava

; Ohjelma käännetään IDL-komentotilassa ensin:
;  .run harj3_teht2_aliohjelma.pro
; Ja se ajetaan seuraavalla komennolla, jossa otetaan
; esimerkiksi 10 lukua ja luvulla 5 tulostetaan jotain 
; yllättävää, ja taulukko tallennetaan muuttujanimeen uusitaulukko:
;  harj3_teht2_aliohjelma,uusitaulukko,10,5
